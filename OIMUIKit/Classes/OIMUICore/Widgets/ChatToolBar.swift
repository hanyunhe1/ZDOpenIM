...
//            }).disposed(by: _disposeBag)
    ...
    func getTempAudioName() -> String {
        return NSHomeDirectory() + "/Documents/audio.m4a"
    }
    
    private lazy var _recorder: AVAudioRecorder = {
        let path = getTempAudioName()
...
//        }
        ...
        self.delegate?.tb_didAudioRecordEnd(url: getTempAudioName(), duration: _seconds)
